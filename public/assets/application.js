...
(function() {
  ...
  Cartridge.IO = (function() {
    ...
    function IO(socket, id) {
      ...
      this.socket.onmessage = function(event) {
        ...
        switch (data.method) {
          ...
          default:
            return console.log("Can't handle", data.method, data, typeof data);
        }
      };
    }
    ...
    IO.prototype.chat = function(message) {
      return this.socket.send(JSON.stringify({
        method: 'chat',
        args: [message]
      }));
...
(function() {
  ...
  Cartridge.Views.PlayerListing = (function(_super) {
    ...
    PlayerListing.prototype.initialize = function(options) {
      this.collection.on('reset', this.render, this);
      this.render();
      return this.cartridge = options.cartridge;
    };
